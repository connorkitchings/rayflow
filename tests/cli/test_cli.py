...
class TestBridgeSend:
    ...
    @patch("rayflow.engine.bridge.artnet.ArtNetSender")
    ...
    @patch("rayflow.engine.bridge.sacn_bridge.SacnSender")
    ...
    def test_bridge_error_propagates(self, mock_sender_cls):
        from rayflow.engine.bridge.exceptions import NetworkError
...
class TestBridgeRecv:
    ...
    @patch("rayflow.engine.bridge.artnet.ArtNetReceiver")
    ...
    @patch("rayflow.engine.bridge.sacn_bridge.SacnReceiver")
...
class TestConsoleCommands:
    ...
    @patch("rayflow.engine.console.osc.Ma3OscFeedbackReceiver")
