...
def test_artnet_apply_expands_sparse_frame_to_universe_buffer() -> None:
    sender_instance = patch("rayflow.bridge.artnet.ArtNetSender").start()
    try:
...
def test_artnet_capture_reports_exact_mismatches() -> None:
    patch("rayflow.bridge.artnet.ArtNetSender").start()
    receiver_class = patch("rayflow.bridge.artnet.ArtNetReceiver").start()
...
def test_sacn_apply_expands_sparse_frame_and_stops_sender() -> None:
    sender_class = patch("rayflow.bridge.sacn_bridge.SacnSender").start()
    try:
...
def test_sacn_apply_can_capture_receiver_universe_state() -> None:
    sender_class = patch("rayflow.bridge.sacn_bridge.SacnSender").start()
    receiver_class = patch("rayflow.bridge.sacn_bridge.SacnReceiver").start()
...
def test_sacn_capture_reports_universe_mismatch() -> None:
    patch("rayflow.bridge.sacn_bridge.SacnSender").start()
    receiver_class = patch("rayflow.bridge.sacn_bridge.SacnReceiver").start()
