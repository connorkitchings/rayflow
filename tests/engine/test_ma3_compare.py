...
def test_generate_observation_produces_expected_shape(sample_gdtf_file: Path):
    from rayflow.engine.fixtures.ma3_compare import generate_observation
...
def test_generate_observation_file_writes_json(sample_gdtf_file: Path, tmp_path: Path):
    from rayflow.engine.fixtures.ma3_compare import generate_observation_file
...
def test_discover_observation_detects_ground_truth():
    from rayflow.engine.fixtures.ma3_compare import discover_observation
